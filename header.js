...
(function () {
  ...
  var html = [
    ...
    '        ' + navLink('/sample.html', 'Samples'),
    '        ' + navLink('/vs-chatgpt.html', 'vs ChatGPT'),
    '        <div class="dropdown">',
    ...
    '            <a href="/download.html">My Account / Download</a>',
    '            <a href="/verified_safe.html">&#128737;&#65039; Verified Safe</a>',
    '            <a href="/terms.html">Terms of Service</a>',
    '            <a href="/privacy.html">Privacy Policy</a>',
    '          </div>',
    '        </div>',
    '        ' + navLink('/download.html', 'My Account') + '
        <a href="/#pricing" class="header-cta">Buy Credits</a>',
    '      </nav>',
